...
def main():
    ...
    print("  URL: https://www.caracore.com.br/secure/super-admin-login.html")
    print()
    print("-" * 80)
    print()
    ...
    print("   https://www.caracore.com.br/secure/super-admin-login.html")
    print()
    print("   E-mail: suporte@caracore.com.br")
    ...
    if save_ref == 's':
        ...
        with open(filename, 'w', encoding='utf-8') as f:
            ...
            f.write("https://www.caracore.com.br/secure/super-admin-login.html\n")
            f.write("-" * 80 + "\n")
