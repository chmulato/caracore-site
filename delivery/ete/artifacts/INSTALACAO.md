# Minerador 4.0 - Instalacao (Canal Institucional)
...
1. Publicar `Minerador40.exe` nesta pasta.
1. Substituir `checksum.sha256` e `checksum.md5` com hashes reais.
1. Validar abertura de `/delivery/ete/download-oficial.html` e do link do endpoint oficial.
