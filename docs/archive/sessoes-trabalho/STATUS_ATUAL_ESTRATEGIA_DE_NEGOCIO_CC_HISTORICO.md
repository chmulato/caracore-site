...
Documento consolidado: trabalho realizado e prÃ³ximos passos possÃ­veis.
Linguagem para uso interno, gestÃ£o e decisÃ£o executiva.
Sem emojis, Ã­cones ou formataÃ§Ã£o decorativa.

Atualizacao de memoria em 25/04/2026:
...
A Cara Core InformÃ¡tica estÃ¡ construindo uma linha de produtos voltada a um pÃºblico seleto e com poder de compra. A ideia central Ã© atuar como uma fÃ¡brica de aplicativos para Windows (desktop) e de conteÃºdo de identidade digital, com foco em:

- SoluÃ§Ãµes que rodam no computador do cliente (Windows), com operaÃ§Ã£o offline quando faz sentido.
- TransparÃªncia com o cliente e respeito Ã  lei de proteÃ§Ã£o de dados (LGPD).
- PreÃ§os claros onde aplicÃ¡vel: valor Ãºnico de R$ 29,90 para upgrades ou produtos de utilidade, seguindo o modelo jÃ¡ validado no Minerador 4.0.
...
- Criada pÃ¡gina de upgrade (upgrade-trono.html) no portal delivery/oidc com valor, forma de pagamento PIX e passos para concluir o upgrade.
...
- Documentada e aplicada a mesma lÃ³gica para os dois produtos que tÃªm vitrine pÃºblica separada:
  ...
  - Cara Core Seed: portal completo no site Cara Core (delivery/seed); vitrine e balcÃ£o pÃºblico no repositÃ³rio caracore-seed-releases (pÃ¡ginas em docs/: apresentaÃ§Ã£o e download do EXE versionado).
...
- Criados no repositÃ³rio caracore-seed os scripts de build e publicaÃ§Ã£o, na mesma lÃ³gica do chmulatoETE Minerador 4.0 (workspace-chi/scripts):
  ...
  - delivery_exe_seed_releases.py: publica o instalador e anexos como Release no GitHub (chmulato/caracore-seed-releases). Usa o token TOKEN_DELIVERY_CC_SEED_TO_REALEASES (ou GH_TOKEN).
...
- Os trÃªs pontos de presenÃ§a do Seed foram alinhados ao visual e Ã  estrutura do portal do Minerador 4.0 (workspace-ete-releases): tema escuro, fonte Inter, cards de metodologia e navegaÃ§Ã£o em grid.
  ...
  - caracore-seed-releases (vitrine, docs/): index e download com o mesmo layout e variÃ¡veis visuais (estilo inline para GitHub Pages).
...
2.11 Circuito Python: produto chamariz e modelo dual (FREE x instituiÃ§Ãµes) â€” mesma lÃ³gica do Minerador 4.0

- Criado o delivery do Circuito Python no site Cara Core (delivery/circuito): index (balcÃ£o), canal-feedback (e-mail suporte@caracore.com.br, WhatsApp e Telegram; nÃ£o atendemos ligaÃ§Ãµes), licenca-uso (FREE MIT para pessoas fÃ­sicas; licenÃ§a obrigatÃ³ria para instituiÃ§Ãµes de ensino â€” R$ 5,00/aluno matriculado/mÃªs) e portal-escolas (regularizaÃ§Ã£o e controle do valor recorrente).
- Criada a filial circuito-python-releases (docs/): balcÃ£o, canal de feedback, licenÃ§a de uso e portal escolas, com base href para GitHub Pages. Controle do valor recorrente mensal (R$ 5,00 por aluno matriculado) e das adesÃµes de escolas Ã© feito pelo portal da filial.
- Alinhamento com a lÃ³gica do chmulatoETE Minerador 4.0: versÃ£o FREE para pessoas fÃ­sicas (jovens entusiastas e curiosos da programaÃ§Ã£o); uso institucional (escolas de ensino mÃ©dio no Brasil) exige licenÃ§a a pagamento. InstituiÃ§Ãµes que utilizarem o curso sem licenÃ§a podem responder legalmente por violaÃ§Ã£o Ã  legislaÃ§Ã£o de direitos autorais e Ã  legislaÃ§Ã£o que tipifica pirataria. Mensagem explÃ­cita em matriz e filial, com profissionalismo da Cara Core InformÃ¡tica.
...
- Release v1.0.0 publicada em https://circuito.caracore.com.br/download.html com CircuitoPython.exe e anexos (checksum.sha256, checksum.md5, INSTALACAO.md). Cliente acessa a versÃ£o mais recente via releases/latest.
...
- NegÃ³cio aplicÃ¡vel: projeto Tia SÃ³cia citado como exemplo de uso do Hub (gestÃ£o logÃ­stica, e-commerce, centros de distribuiÃ§Ã£o). NÃ£o esquecemos o Tia SÃ³cia: ele faz parte do ecossistema para o qual o Hub foi pensado.
...
- Loja (caracore-ru-releases/docs) alinhada Ã  matriz (delivery/ru): nome RU Soberano, aviso produto em evoluÃ§Ã£o, CTAs e mensagem (expectativa Ã— realidade, CafÃ© Mania 2.0 vs material sÃ©rio de engenharia); breadcrumbs PortfÃ³lio Â· Delivery Â· Loja; MIRROR_DELIVERY.md na loja com regras de espelho. MemÃ³ria do projeto (caracore-ru .cursor/rules/project-memory.mdc) atualizada com seÃ§Ã£o Ecossistema â€” matriz, loja, garagem.
...
- PÃºblico: pequenos e mÃ©dios negÃ³cios, varejo, contador e gestor.
...
- PreÃ§o: FREE (MIT) para indivÃ­duos; R$ 5,00 mensais por aluno matriculado para escolas, controle na filial circuito-python-releases.
...
- PreÃ§o: R$ 29,90 (jornada completa â€” InteligÃªncia de Processo + Memorial RU); degustaÃ§Ã£o FREE atÃ© o Buffet.
...
- Circuito Python: portal = site Cara Core, pasta delivery/circuito (index com card Download â†’ releases/latest e card RepositÃ³rio pÃºblico de releases, canal-feedback, licenca-uso, portal-escolas); loja online = circuito-python-releases (circuito.caracore.com.br), pasta docs/. Prioridade: baixar o EXE; link do curso em HTML nÃ£o Ã© destacado. Releases: CircuitoPython.exe, checksums e INSTALACAO.md (v1.0.0). NÃ£o apontamos para o repositÃ³rio privado (circuito_python). Mensagem: FREE para pessoas fÃ­sicas; instituiÃ§Ãµes com licenÃ§a obrigatÃ³ria R$ 5,00/aluno/mÃªs; aviso de responsabilizaÃ§Ã£o legal; diploma com assinatura criptogrÃ¡fica. Ao alterar a matriz, atualizar a filial.
- Cara Core PDV: portal (matriz) = site Cara Core, pasta delivery/pdv (apresentaÃ§Ã£o completa, economia, planos, Wiki Fiscal, consultoria); loja online = caracore-pdv-releases (https://pdv.caracore.com.br/). Documentado em delivery/pdv/MIRROR_DELIVERY.md. Mensagem alinhada (PDV Selo Verde, Reforma 2026, DegustaÃ§Ã£o). Ao alterar a matriz, considerar atualizar a loja para manter conteÃºdo alinhado.
- Cara Core Hub: portal (matriz) = site Cara Core, pasta delivery/hub (index, download, canal-feedback, tecnologia, slides/apresentacao_tia_socia.html); loja online = caracore-hub-releases (https://hub.caracore.com.br/) â€” mesmo conteÃºdo; base href para GitHub Pages; slides/ com apresentaÃ§Ã£o Tia SÃ³cia e imagens. Mensagem: gestÃ£o logÃ­stica e e-commerce; SQLite local; autonomia local; negÃ³cio aplicÃ¡vel Tia SÃ³cia. Releases (WAR, instruÃ§Ãµes) em https://hub.caracore.com.br/download.html quando publicadas. Ao alterar a matriz, considerar atualizar a vitrine para manter conteÃºdo alinhado.
- Suporte Ãrea 51: portal (matriz) = site Cara Core, pasta delivery/area51 (index, canal-feedback); loja online = caracore-area51-releases (https://area51.caracore.com.br/). Mensagem: produto para empresas mÃ©dias; exige tempo e investimento (energia da startup). Documentado em delivery/area51/MIRROR_DELIVERY.md. Ao alterar a matriz, atualizar a loja para manter conteÃºdo alinhado.
