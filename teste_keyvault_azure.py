#!/usr/bin/env python3
"""
Script específico para testar a integração com Azure Key Vault.
...
def test_keyvault_integration(base_url: str, timeout: int = 30) -> dict:
    ...
    try:
        ...
        print(f"✅ Health endpoint OK: {health_data.get('status', 'unknown')}")
        ...
        # Status 400/401 é esperado com código inválido, indica que Key Vault está OK
            ...
            try:
                ...
                if any(phrase in error_msg.lower() for phrase in [
                    ...
                    return {
                        "success": True,
                        "message": "✅ Key Vault integração OK - GOOGLE_CLIENT_SECRET está sendo carregado corretamente",
                        "details": {
...
def main():
    ...
    print("🔐 TESTE DE INTEGRAÇÃO AZURE KEY VAULT")
    print("=" * 50)
