...
| Canal | `v3.2.2-free` (download). Candidato `v4.0.0-rc1` = pré-release, não substitui o Free. |
...
**Estado (2026-09-05):** candidato `v4.0.0-rc1` publicado. Canal maduro = `v3.2.2-free`. T032/GA bloqueado. Planos = `PlanoLicencaService` (Free 100/mês + 4 vendedores / 1 loja / 10 SMS). Não substitui o PDV Rust.
