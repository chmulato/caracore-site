...
Or pass custom values:
  python scripts/validate_oidc_endpoints.py --base-url https://www.caracore.com.br --redirect-path /secure/index.html \
      --google-client 1023942712021-7k4aalpg2oeenhisln9tk9s15m26iruu --microsoft-client 8ef17663-438f-4777-99ca-c5ad5b2a2993
...
def main(argv=None):
    ...
    p.add_argument('--microsoft-client', default='8ef17663-438f-4777-99ca-c5ad5b2a2993', help='Microsoft client id')
