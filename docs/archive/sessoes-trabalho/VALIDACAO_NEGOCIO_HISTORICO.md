...
## 1. Cara Core PDV â€” validado com muito esforÃ§o
  ...
  5. Cara Core Hub â€” gestÃ£o logÃ­stica e e-commerce; portal delivery (matriz + vitrine); SQLite local; negÃ³cio aplicÃ¡vel: Tia SÃ³cia; apresentaÃ§Ã£o Tia SÃ³cia em slides/
  6. Suporte Ãrea 51 â€” suporte Ã s empresas mÃ©dias do Brasil para configurar os portais que o produto Ãrea 51 oferece (OAuth 2.1, OIDC, PKCE); matriz delivery/area51 + loja caracore-area51-releases; exige tempo e investimento

Garagem (futuros lanÃ§amentos â€” matriz, oficina e loja jÃ¡ no ar):
  8. RU Soberano â€” simulador reator PFR (Langmuir-Hinshelwood), histÃ³ria do RU e Engenharia QuÃ­mica (1991â†’2026); matriz delivery/ru, loja caracore-ru-releases, oficina caracore-ru; lanÃ§amento previsto 18/Junho/2026; R$ 29,90; degustaÃ§Ã£o FREE atÃ© o Buffet; ramo Garagem em ecosistema.html
...
## 1. NARRATIVA DE NEGÃ“CIO (FÃBRICA + PÃšBLICO SELETO)
  ...
  ---------------------------------|-------------|----------------------------------------------------------------
  FÃ¡brica de apps Windows Desktop  | ImplÃ­cito   | PDV (web + offline/Electron), Minerador (Windows .exe), Seed (Windows .exe) estÃ£o alinhados. Reino OIDC Ã© web/educaÃ§Ã£o â€” complementar (identidade, formaÃ§Ã£o). Vale deixar explÃ­cito no portfÃ³lio uma linha que una os quatro: ex. "SoluÃ§Ãµes Windows Desktop e identidade para um pÃºblico seleto".
...
### 2.1 Cara Core PDV
  ...
  --------------------------|--------|--------------------------------------------------------
  Escopo                    | OK     | Foco localhost e Windows Desktop (EXE sobe em localhost:8080); banco apenas SQLite (nÃ£o PostgreSQL, nÃ£o H2). Wiki e portfÃ³lio atualizados.
  Proposta de valor clara   | OK     | Reforma TributÃ¡ria 2026-2033, offline, PIX Split, planos Free/Premium; PDV Selo Verde; mensagem alinhada Ã  matriz.
  PÃºblico                   | OK     | Pequenos e mÃ©dios negÃ³cios, varejo; contador e gestor.
  PreÃ§o/plano               | AtenÃ§Ã£o| Free e Premium descritos; valor do Premium nÃ£o estÃ¡ no portfÃ³lio (pode ser intencional).
  Delivery funcional        | OK     | Matriz: portfolio.html#caracore-pdv; loja https://pdv.caracore.com.br/ (v3.1.2-free). Legado /delivery/pdv/ redirect.
  Windows Desktop           | OK     | Instalador EXE; ao abrir, servidor sobe em localhost; um arquivo de dados (SQLite); modo offline; Electron.
...
### 2.2 chmulatoETE Minerador 4.0
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Proposta de valor         | OK     | ETE aplicada ao refino de terras raras; instalador Windows; checksums; upgrade Ouro 4.0.
  PÃºblico                   | OK     | MineraÃ§Ã£o, hidrometalurgia, educaÃ§Ã£o (Campo Largo).
  PreÃ§o                     | AtenÃ§Ã£o| R$ 29,90 (Ouro 4.0) estÃ¡ no portal ETE (upgrade-ouro40.html), nÃ£o no texto do portfÃ³lio. Para consistÃªncia com Seed, vale citar no lead ou no alerta.
  Delivery funcional        | OK     | delivery/ete/, delivery/ete/download.html â†’ GitHub caracore-ete-releases.
  Windows Desktop           | OK     | Instalador .exe, checksums SHA-256/MD5.
...
### 2.3 Reino OIDC â€” Reino das Identidades Federadas
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Proposta de valor         | OK     | Material educacional OAuth 2.1 / OIDC; gamificaÃ§Ã£o; PI Cara Core. Primeira entrega FREE; upgrade O Trono da Identidade R$ 29,90 (inspirado no Minerador 4.0). Prioridade: incentivar baixar o EXE; link para conteÃºdo em HTML nÃ£o Ã© destacado (wiki, portfÃ³lio, filial).
  PÃºblico                   | OK     | Jovens Entusiastas Desenvolvedores (foco em pÃºblico-alvo feminino); mercado seleto, olhar crÃ­tico; Security, Big Tech.
  PreÃ§o                     | OK     | FREE (MIT) + upgrade R$ 29,90 (valor Ãºnico).
  Delivery funcional        | OK     | delivery/oidc/ â†’ index (FREE), download.html (ReinoOIDC.exe â†’ releases/latest), upgrade-trono.html â†’ PIX R$ 29,90. Filial reino_oidc_releases (docs/) com card Download em destaque; sem card "ConteÃºdo FREE" (HTML) no balcÃ£o.
  Windows Desktop           | OK     | Aplicativo FREE ReinoOIDC.exe em https://oidc.caracore.com.br/download.html. Papel no ecossistema: reforÃ§a marca "identidade" e atrai talento; nÃ£o compete com PDV/Minerador/Seed.
...
### 2.4 Cara Core Seed
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Posicionamento            | OK     | Produto existe, aplicaÃ§Ã£o nÃ£o disponÃ­vel. Foco em aplicaÃ§Ãµes relevantes para o negÃ³cio; sem braÃ§o para a startup. Seed consta no portfÃ³lio no final da lista; sem oferta de download nem venda.
  Proposta de valor         | Ref.   | Contador de LicenÃ§as (ferramenta interna); nÃ£o estÃ¡ em entrega ativa.
  PreÃ§o                     | N/A    | AplicaÃ§Ã£o nÃ£o disponÃ­vel â€” sem preÃ§o nem CTA de compra.
  Delivery                  | OK     | delivery/seed e caracore-seed-releases informam que a aplicaÃ§Ã£o nÃ£o estÃ¡ disponÃ­vel; sem Baixar EXE nem Comprar. PortfÃ³lio: seÃ§Ã£o no final, texto "existe, aplicaÃ§Ã£o nÃ£o disponÃ­vel"; links apenas para Portal Seed (informativo) e repositÃ³rio.
...
### 2.5 Circuito Ferradura
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Proposta de valor         | OK     | Curso proprietario de logica, abaco romano e Python para jovens entusiastas; gratuito para pessoas fisicas; licenca obrigatoria para instituicoes (R$ 5,00/aluno/mes); aviso de responsabilizacao legal. Prioridade de comunicacao: loja oficial, curso web e download.
  PÃºblico                   | OK     | Pessoas fÃ­sicas (FREE); instituiÃ§Ãµes de ensino mÃ©dio (licenÃ§a paga).
  PreÃ§o                     | OK     | FREE (MIT) para indivÃ­duos; R$ 5,00/aluno matriculado/mÃªs para escolas.
  Delivery funcional        | OK     | delivery/circuito/ e loja caracore-circuito-releases/docs/ com balcao, download, curso web, canal-feedback, licenca-uso e portal-escolas.
  Windows Desktop           | OK     | CircuitoFerradura.exe em https://circuito.caracore.com.br/download.html.
  RepositÃ³rio pÃºblico       | OK     | Loja oficial em https://circuito.caracore.com.br/. Oficina: caracore-circuito. Loja: caracore-circuito-releases.
...
### 2.6 Cara Core Hub
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Proposta de valor         | OK     | GestÃ£o logÃ­stica e e-commerce; centros de distribuiÃ§Ã£o; recebimento, triagem, estoque, retirada; integraÃ§Ã£o marketplaces; SQLite local, autonomia local.
  NegÃ³cio aplicÃ¡vel         | OK     | Projeto Tia SÃ³cia citado como exemplo; apresentaÃ§Ã£o (pitch deck, 21 slides) em slides/ na loja (caracore-hub-releases) e na matriz (delivery/hub).
  PreÃ§o                     | N/A    | B2B / sob consulta ou modelo futuro; nÃ£o fixado no portal.
...
### 2.7 Suporte Ãrea 51
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Proposta de valor         | OK     | Produto Ãrea 51 oferece portais (login, painel admin, controle de acesso, auditoria). Suporte Ãrea 51 = serviÃ§o para empresas mÃ©dias do Brasil configurarem esses portais (OAuth 2.1, OIDC, PKCE, Google, Microsoft, LGPD).
...
### 2.8 RU Soberano (Garagem â€” futuros lanÃ§amentos)
  ...
  CritÃ©rio                  | Status | Detalhe
  --------------------------|--------|--------------------------------------------------------
  Posicionamento            | OK     | Produto na Garagem (ecosistema.html): matriz, oficina e loja no ar; lanÃ§amento 18/Junho/2026. Simulador reator PFR, histÃ³ria do RU e Engenharia QuÃ­mica (1991â†’2026).
  Proposta de valor         | OK     | InteligÃªncia de Processo + Memorial RU; degustaÃ§Ã£o FREE atÃ© o Buffet; R$ 29,90 jornada completa; produto em evoluÃ§Ã£o; expectativa Ã— realidade (CafÃ© Mania 2.0 vs material sÃ©rio).
  PreÃ§o                     | OK     | R$ 29,90 (jornada completa); degustaÃ§Ã£o FREE atÃ© o Buffet.
...
## 3. FUNCIONALIDADE DOS FLUXOS (CLIENTE FINAL)
  ...
  -------------------------------|-------------------------------------------------------------------------------------|----------
  Conhecer PDV / Baixar EXE PDV   | PortfÃ³lio â†’ Ver ApresentaÃ§Ã£o (matriz delivery/pdv/) ou Ver loja (releases) â†’ pdv.caracore.com.br/ ou delivery/pdv/download.html | Sim (escopo: localhost + Windows Desktop; banco SQLite)
  Baixar Minerador 4.0           | PortfÃ³lio â†’ Download â†’ delivery/ete/download.html â†’ GitHub caracore-ete-releases/latest      | Sim
  Reino OIDC â€” baixar EXE FREE   | PortfÃ³lio â†’ delivery/oidc/ ou reino_oidc_releases â†’ download.html â†’ releases/latest (ReinoOIDC.exe) | Sim (prioridade: EXE; conteÃºdo HTML nÃ£o destacado)
  Conhecer Seed (sem download)    | PortfÃ³lio (seÃ§Ã£o no final) ou delivery/seed / caracore-seed-releases â†’ apenas informaÃ§Ã£o de que o produto existe e a aplicaÃ§Ã£o nÃ£o estÃ¡ disponÃ­vel | Sim (sem oferta de EXE nem compra)
  Circuito Ferradura â€” loja e download | PortfÃ³lio â†’ circuito.caracore.com.br â†’ Download / Curso / Portal Escolas | Sim; curso web e EXE alinhados
  Cara Core Hub â€” portal / Tia SÃ³cia | PortfÃ³lio â†’ delivery/hub/ ou caracore-hub-releases â†’ index, download (releases quando houver), ApresentaÃ§Ã£o Tia SÃ³cia (slides/) | Sim; SQLite local; negÃ³cio aplicÃ¡vel Tia SÃ³cia
...
## 4. CONSISTÃŠNCIA DE MENSAGEM (PÃšBLICO SELETO)
  ...
  -------------------------------|------------------------|-------------------------|-------------------------------|-------------------|---------------------------|----------------------------|----------------------------------|----------------------------------
  Nome completo / posicionamento| Cara Core PDV          | chmulatoETE Minerador 4.0| Reino OIDC â€” Reino das Id. Fed.| Cara Core Seed (existe; app nÃ£o disponÃ­vel) | Circuito Ferradura | Cara Core Hub (gestÃ£o logÃ­stica; SQLite; Tia SÃ³cia) | Suporte Ãrea 51 (configurar portais; empresas mÃ©dias Brasil) | RU Soberano (reator PFR; histÃ³ria RU + Eng. QuÃ­mica; Garagem)
  Escopo                        | localhost + Windows Desktop; SQLite | â€”                | Prioridade EXE                 | Ref. interna      | Prioridade EXE            | WAR/Tomcat; SQLite local  | OAuth 2.1, OIDC, PKCE; portais | Reator PFR; degustaÃ§Ã£o FREE; R$ 29,90
  PreÃ§o visÃ­vel                 | Free + Premium (nÃ£o citado) | Free + Ouro 4.0 R$ 29,90 | FREE + upgrade R$ 29,90       | N/A (nÃ£o disponÃ­vel) | FREE (MIT); escolas R$ 5,00/aluno/mÃªs | B2B / sob consulta | Sob consulta | R$ 29,90; degustaÃ§Ã£o FREE
  Entrega Windows               | Sim (EXE â†’ localhost:8080) | Sim (.exe)              | Sim (ReinoOIDC.exe FREE)      | NÃ£o (nÃ£o disponÃ­vel) | Sim (CircuitoPython.exe)  | WAR (releases quando houver) | ServiÃ§o (nÃ£o EXE) | Soberania_RU_v1.0 (lanÃ§amento 18/Jun/2026)
...
## 5. RESUMO DE AÃ‡Ã•ES RECOMENDADAS
  ...
  3. Seed: Produto existe, aplicaÃ§Ã£o nÃ£o disponÃ­vel. NÃ£o oferecer Baixar EXE nem Comprar; portfÃ³lio com seÃ§Ã£o no final; delivery e vitrine apenas informam que existe. Foco em aplicaÃ§Ãµes relevantes para o negÃ³cio.
  4. Reino OIDC: Manter nome completo "Reino OIDC â€” Reino das Identidades Federadas" em qualquer novo material; download do EXE FREE (ReinoOIDC.exe) disponÃ­vel em delivery/oidc e reino_oidc_releases.
