...
- [ ] PDV Rust: CTAs → **pdv-rust.caracore.com.br**; portfólio usa `#pdv-coexistencia` para comparação Java/Rust.
...
- [ ] Páginas novas **indexáveis** têm `<link rel="canonical">` absoluto em `https://www.caracore.com.br/...`.
...
- [ ] Submeter `https://www.caracore.com.br/sitemap.xml` no Search Console (se alterado o sitemap ou URLs críticas).
