...
**Client ID:** `***AZURE_SECRET_REDACTED***`
...
```text
🔍 Busque por Client ID: ***AZURE_SECRET_REDACTED***
...
```text
https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?client_id=***AZURE_SECRET_REDACTED***&redirect_uri=https://www.caracore.com.br/secure/callback.html&response_type=code&scope=openid profile email
```
...
```text
🔍 Busque por: ***AZURE_SECRET_REDACTED***
...
- [ ] Encontrou app por Client ID: `***AZURE_SECRET_REDACTED***`
